        ...
        <div className="mx-auto w-full max-w-2xl space-y-8">
          <div className="gap-2 flex justify-between">
            ...
            <BlurFadeText
              ...
              <BlurFadeText
                delay={BLUR_FADE_DELAY}
                className="text-xl font-sans tracking-tighter sm:text-2xl xl:text-2xl/none"
                yOffset={6}
                text="software engineer with an interest in"
              />
              <WordRotate
                className="inline-flex w-full text-left font-sans leading-none tracking-tighter"
                words={[
                  "API Design.",
                  "Backend Development.",
                  "CI/CD",
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ...
                  websites to complex mobile applications. Here are a few i can share
                </p>
              </div>
            </div>
          </BlurFade>
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                and I&apos;ll respond in no time or{" "}
                <Link
